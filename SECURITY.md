...
| Supply chain | locked dependencies, weekly automated updates, vulnerability audit and secret scanning in CI, GitHub Actions pinned to full commit SHAs and container base images pinned by digest, vendored front-end assets |
