...
Status: version 1.1.4, beta, maintained as a portfolio project.
...
The fast suite (unit and web) is 201 tests at 99.20 % line and branch coverage; that figure comes
